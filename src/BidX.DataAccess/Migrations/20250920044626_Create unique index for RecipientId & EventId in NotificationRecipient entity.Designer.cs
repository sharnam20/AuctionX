...
namespace BidX.DataAccess.Migrations
{
    ...
    [Migration("20250920044626_Create unique index for RecipientId & EventId in NotificationRecipient entity")]
    partial class CreateuniqueindexforRecipientIdEventIdinNotificationRecipiententity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BidX.DataAccess.Entites.OutboxMessage", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("CreatedAt", "ProcessedAt"), new[] { "Id", "Type", "Content" });
